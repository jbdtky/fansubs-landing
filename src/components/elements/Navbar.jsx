                    ...
                    >
                        <ul className="flex flex-col lg:flex-row gap-y-8 w-full m-auto text-center gap-x-8 lg:justify-center lg:items-center">
                            ...
                            <li className="hidden lg:block ml-auto">
                                <a href="https://www.instagram.com/fansubsapp" target="_blank" className="group  text-white  hover:text-[#8120D5]  transition-colors duration-300">
                            ...
                            <li className="hidden lg:block">
                                <a href="https://x.com/fansubsapp" target="_blank" className="group  text-white  hover:text-[#8120D5]  transition-colors duration-300">
