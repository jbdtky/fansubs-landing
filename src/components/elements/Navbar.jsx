          ...
          <div className="min-w-max inline-flex relative">
            <Link to={"/"} className="relative flex items-center gap-3">
              <img
                src={logo}
                alt="FanSubs Logo"
                className="w-[125px] h-[40px] lg:w-50 lg:h-16"
              />
            </Link>
          </div>
          ...
          >
            <ul className="flex flex-col lg:flex-row gap-y-8 w-full m-auto text-center gap-x-8 lg:justify-center lg:items-center">
              ...
              <li className="hidden lg:block ml-auto">
                <a
                  href="https://www.instagram.com/fansubsapp"
                  target="_blank"
                  className="group  text-white  hover:text-[#8120D5]  transition-colors duration-300"
                >
                  <svg
