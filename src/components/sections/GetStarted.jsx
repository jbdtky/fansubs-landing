        ...
        <section className="relative overflow-x-clip scroll-mt-[70px]" id="get-started" >
            ...
            <Container>
                <div className="flex flex-col items-center lg:mt-[125px] mt-[50px]">
                    <Title element="h2" className="text-[28px] max-w-[85%] lg:max-w-full lg:text-[48px] mb-[15px] text-white impact-text !font-normal">New here? Sign up and start earning in minutes </Title>
